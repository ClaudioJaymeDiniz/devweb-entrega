...
import { TipoAcomodacao } from "../types"
...
export default function Acomodacoes() {
  ...
  const [formData, setFormData] = useState({
    nome_acomodacao: TipoAcomodacao.SolteiroSimples,
    cama_solteiro: 0,
    cama_casal: 0,
    suite: 0,
    climatizacao: false,
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData({ ...formData, nome_acomodacao: value as TipoAcomodacao })}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Selecione o tipo de acomodação" />
                  </SelectTrigger>
                  <SelectContent>
                    {Object.values(TipoAcomodacao).map((nome) => (
